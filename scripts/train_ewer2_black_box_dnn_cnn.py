...
train_feats_p_w_n  = np.hstack((train_data[data.continuous_black], train_feats_p,train_feats_w))
dev_feats_p_w_n   = np.hstack((dev_data[data.continuous_black], dev_feats_p,dev_feats_w))
test_feats_p_w_n  = np.hstack((test_data[data.continuous_black], test_feats_p,test_feats_w))
...
final_model='eWER2_black_box_dnn_cnn'
...
model.fit([train_data[data.continuous_black], train_mfcc, train_feats_p, train_feats_w], train_data["wer"].to_numpy(),
           validation_data=([dev_data[data.continuous_black], dev_mfcc, dev_feats_p, dev_feats_w], dev_data["wer"].to_numpy()),
