...
wer2_glass= np.load("./results/summa_eWER2_black_box_dnn_cnn_pred_agg.npy")
wer2_black= np.load("./results/summa_eWER2_glass_box_dnn_cnn_pred_agg.npy")
wer2_no= np.load("./results/summa_eWER2_no_box_dnn_cnn_pred_agg.npy")
