...
train_feats_p_w_n  = np.hstack((train_data[data.continuous_glass], train_feats_p,train_feats_w))
dev_feats_p_w_n   = np.hstack((dev_data[data.continuous_glass], dev_feats_p,dev_feats_w))
test_feats_p_w_n  = np.hstack((test_data[data.continuous_glass], test_feats_p,test_feats_w))
...
final_model='eWER2_glass_box_dnn_cnn'
